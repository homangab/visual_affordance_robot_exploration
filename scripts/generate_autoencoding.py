...
def sample_videos(args):
   ...
   # vt.eval()
    ...
    print(images.shape)
    assert images.shape == (n_prime, 3, 128, 128)
    ...
    # new_sequence = latent_sequence.new_zeros(4, nc, h, w)
    ...
    sample = vqvae.decode(latent_sequence)  # DELETE this line
    ...
    save_video(sample, 'auto_encoding_test/output')
